...
from playlists.views import MovieListView, TVShowListView, FeaturedPlaylistListView, MovieDetailView, PlaylistDetailView, TVShowSeasonDetailView,TVShowDetailView
